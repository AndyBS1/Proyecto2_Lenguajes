...
/* package echo-0.1.4 */
#ifndef VERSION_echo
#define VERSION_echo "0.1.4"
#endif /* VERSION_echo */
#ifndef MIN_VERSION_echo
#define MIN_VERSION_echo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "password-manager-0.1.0.0-DOCBkOmVFtgGVvk5CDvNIY-password-manager"
